...
const Homepage = () => {
  ...
  return (
    <div className="">
      ...
      <div className="space-y-10 py-20">
      <HomeProductSection data={mens_kurta} section={"Wedding wear"} />
        <HomeProductSection data={mensShoesPage1} section={"Venue and Decor"} />
        <HomeProductSection data={sareePage1} section={"Theme Parties"} />
        {/* <HomeProductSection data={dressPage1} section={"Dress"} /> */}
        {/* <HomeProductSection data={gounsPage1} section={"Women's Gouns"} /> */}
        {/* <HomeProductSection data={kurtaPage1} section={"Women's Kurtas"} /> */}
        {/* <HomeProductSection data={lengha_page1} section={"Custom Menu"} /> */}
        {/* <HomeProductSection data={mensPantsPage1} section={"Men's Pants"} /> */}
      </div>
